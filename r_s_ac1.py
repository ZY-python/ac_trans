...
# from utils.return_dataset2 import return_dataset2, return_dataset_test2#是SVHN->mnist
from utils.return_dataset import return_dataset, return_dataset_test, return_dataset_a, return_dataset_r, return_source,return_rand_source
from utils.loss import entropy, adentropy
from active_semi import active_L_c, active_f,get_target_l,get_target_un
from res_ac import active
...
parser.add_argument('--NUM_TRAIN_s', type=int, default=70358)
parser.add_argument('--initial_size', type=int, default=126)  # 初始化个数
parser.add_argument('--batch_size', type=int, default=126)

parser.add_argument('--BATCH_AC', type=int, default=5)  # 目标域主动学习的batch
parser.add_argument('--BATCH_AC0', type=int, default=62)  # 源域主动学习的batch
parser.add_argument('--BATCH_AC1', type=int, default=1) #得到单个标签
parser.add_argument('--MARGIN', type=float, default=1.0)
parser.add_argument('--WEIGHT', type=float, default=1.0)
parser.add_argument('--TRIALS', type=int, default=1)
parser.add_argument('--CYCLES0', type=int, default=11)  # 已修改
...
# f_lab_set = random.sample(range(0, 70358), 50400)
...
record_dir = "record/multi/MME/R_S_d_domain.txt"  # 保存每次step的准确率
